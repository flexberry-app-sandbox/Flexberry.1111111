...
namespace IIS.111111
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.111111.Номенклатура fНоменклатура;
        
        private IIS.111111.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.111111.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.111111.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.111111.ЗаказПост.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.111111.ЗаказПост",
                "IIS.111111.ОтчетОЗак"})]
        public virtual IIS.111111.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.111111.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.111111.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.111111.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.111111.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.111111.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.111111.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.111111.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.111111.ТЧЗаказ dataobject)
        {
