...
namespace IIS.111111
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.111111.DetailArrayOfПлан fПлан;
        ...
        public virtual IIS.111111.DetailArrayOfПлан План
        {
            get
            {
                ...
                if ((this.fПлан == null))
                {
                    this.fПлан = new IIS.111111.DetailArrayOfПлан(this);
                }
                IIS.111111.DetailArrayOfПлан result = this.fПлан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.111111.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.111111.ПланЗакупок));
                }
            }
        }
    }
