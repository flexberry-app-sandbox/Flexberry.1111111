...
namespace IIS.111111
{
    ...
    public class Номенклатура : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.111111.ЕдиницыИзмер fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.111111.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.111111.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НоменклатураE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураE", typeof(IIS.111111.Номенклатура));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НоменклатураL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураL", typeof(IIS.111111.Номенклатура));
                }
            }
        }
    }
