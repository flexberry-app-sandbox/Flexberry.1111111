...
namespace IIS.111111
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.111111.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.111111.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.111111.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.111111.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.111111.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.111111.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.111111.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.111111.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.111111.План this[int index]
        {
            get
            {
                return ((IIS.111111.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.111111.План dataobject)
        {
