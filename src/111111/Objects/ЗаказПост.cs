...
namespace IIS.111111
{
    ...
    public class ЗаказПост : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.111111.СостОплаты fСостояниеОплаты;
        
        private bool fСуммаВклНДС;
        
        private int fСуммаДокумента;
        
        private IIS.111111.СостОтгрузки fСостОтгрузки;
        
        private System.DateTime fДатаНачала = System.DateTime.Now;
        
        private System.DateTime fДатаОкончания;
        
        private IIS.111111.Контрагенты fКонтрагенты;
        
        private IIS.111111.Склады fСклады;
        
        private IIS.111111.Организации fОрганизации;
        
        private IIS.111111.DetailArrayOfТЧЗаказ fТЧЗаказ;
        ...
        public virtual IIS.111111.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.111111.СостОтгрузки result = this.fСостОтгрузки;
        ...
        public virtual IIS.111111.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.111111.СостОплаты result = this.fСостояниеОплаты;
        ...
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        [NotNull()]
        public virtual IIS.111111.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.111111.Контрагенты result = this.fКонтрагенты;
        ...
        [PropertyStorage(new string[] {
                "Организации"})]
        [NotNull()]
        public virtual IIS.111111.Организации Организации
        {
            get
            {
                ...
                IIS.111111.Организации result = this.fОрганизации;
        ...
        [PropertyStorage(new string[] {
                "Склады"})]
        [NotNull()]
        public virtual IIS.111111.Склады Склады
        {
            get
            {
                ...
                IIS.111111.Склады result = this.fСклады;
        ...
        public virtual IIS.111111.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                {
                    this.fТЧЗаказ = new IIS.111111.DetailArrayOfТЧЗаказ(this);
                }
                IIS.111111.DetailArrayOfТЧЗаказ result = this.fТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.111111.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.111111.ЗаказПост));
                }
            }
        }
    }
