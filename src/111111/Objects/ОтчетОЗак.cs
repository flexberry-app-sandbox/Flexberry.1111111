...
namespace IIS.111111
{
    ...
    public class ОтчетОЗак : IIS.111111.ЗаказПост
    {
        ...
        public override IIS.111111.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.111111.СостОтгрузки result = base.СостОтгрузки;
        ...
        public override IIS.111111.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.111111.СостОплаты result = base.СостояниеОплаты;
        ...
        [TypeUsage(typeof(IIS.111111.Контрагенты))]
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        public override IIS.111111.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.111111.Контрагенты result = ((IIS.111111.Контрагенты)(base.Контрагенты));
            ...
            set
            {
                ...
                base.Контрагенты = ((IIS.111111.Контрагенты)(value));
        ...
        [TypeUsage(typeof(IIS.111111.Организации))]
        [PropertyStorage(new string[] {
                "Организации"})]
        public override IIS.111111.Организации Организации
        {
            get
            {
                ...
                IIS.111111.Организации result = ((IIS.111111.Организации)(base.Организации));
            ...
            set
            {
                ...
                base.Организации = ((IIS.111111.Организации)(value));
        ...
        [TypeUsage(typeof(IIS.111111.Склады))]
        [PropertyStorage(new string[] {
                "Склады"})]
        public override IIS.111111.Склады Склады
        {
            get
            {
                ...
                IIS.111111.Склады result = ((IIS.111111.Склады)(base.Склады));
            ...
            set
            {
                ...
                base.Склады = ((IIS.111111.Склады)(value));
        ...
        public override IIS.111111.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                IIS.111111.DetailArrayOfТЧЗаказ result = base.ТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакE", typeof(IIS.111111.ОтчетОЗак));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакL", typeof(IIS.111111.ОтчетОЗак));
                }
            }
        }
    }
